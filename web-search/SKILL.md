...
- **max_results**: Optional. Number of top results to fetch full content for. Integer between 1 and 5, default is 3. Use fewer (1–2) for focused factual questions, more (4–5) for broad research tasks.

## Examples

- User: "2026年のAI動向を教えて" → `{ "query": "2026年 AI 動向 最新", "max_results": 3 }`
...
- User: "Compare React and Vue in 2026" → `{ "query": "React vs Vue 2026 comparison", "max_results": 4 }`
